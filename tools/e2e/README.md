...
- `probe-p2-chat-virtual.cjs` — v3.32 P2.4 聊天虚拟滚动回归：注入 1000 条消息 →
  DOM 渲染节点数（11 条级）远小于总量、spacer 撑开滚动区、底部/顶部内容可达
- `probe-p3-wrongbook.cjs` — v3.33 P3.1 错题本回归：播种含错题 history → 错题列表/我的答案/标准答案/AI 讲解按钮渲染；题库页导入/导出/批量入口与批量栏状态
