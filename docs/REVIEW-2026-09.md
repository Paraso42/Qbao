...
> （nginx + VPN 内网模式 + 大陆源站）反映的是迁港**之前**的架构。2026-09-10 服务已全量迁至香港单机
> （Caddy 同机 TLS + 静态直出 + 反代）。**当前架构事实源为 [ARCHITECTURE.md](ARCHITECTURE.md)**，
...
> 详细整改记录见 [ARCHITECTURE.md](ARCHITECTURE.md) §9（R1–R12）。
